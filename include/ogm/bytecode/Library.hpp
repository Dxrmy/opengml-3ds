...
public:
    ...
    // returns true if the function is provided by the library.
    virtual bool has_function(const char* functionName) const = 0;
...
class EmptyLibrary : public Library
{
    ...
    bool has_function(const char* functionName) const
    { return false; }
