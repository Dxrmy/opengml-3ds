...
void ogm::interpreter::fn::asset_get_type(VO out, V asset)
{
    ...
    {
        out = static_cast<real_t>(constant::asset_object);
    }
    else if (dynamic_cast<AssetSprite*>(a))
    {
        out = static_cast<real_t>(constant::asset_sprite);
    }
    else if (dynamic_cast<AssetSound*>(a))
    {
        out = static_cast<real_t>(constant::asset_sound);
    }
    else if (dynamic_cast<AssetBackground*>(a))
    {
        out = static_cast<real_t>(constant::asset_background);
    }
    else if (dynamic_cast<AssetRoom*>(a))
    {
        out = static_cast<real_t>(constant::asset_room);

    }
    else if (dynamic_cast<AssetFont*>(a))
    {
        out = static_cast<real_t>(constant::asset_font);
    }
    else if (dynamic_cast<AssetScript*>(a))
    {
        out = static_cast<real_t>(constant::asset_script);
    }
    else if (dynamic_cast<AssetShader*>(a))
    {
        out = static_cast<real_t>(constant::asset_shader);
    }
    else
    {
        out = static_cast<real_t>(constant::asset_unknown);
    }
}
